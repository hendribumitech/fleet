...
{    
    ...
    */
    ...
    {
        return [
            'code' => new Column(['title' => __('models/categories.fields.code'),'name' => 'code', 'data' => 'code', 'searchable' => true, 'elmsearch' => 'text']),
            'name' => new Column(['title' => __('models/categories.fields.name'),'name' => 'name', 'data' => 'name', 'searchable' => true, 'elmsearch' => 'text'])
        ];
    }

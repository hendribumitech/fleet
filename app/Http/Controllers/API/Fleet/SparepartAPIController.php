...
use App\Http\Requests\API\Fleet\CreateSparepartAPIRequest;
use App\Http\Requests\API\Fleet\UpdateSparepartAPIRequest;
use App\Models\Fleet\Sparepart;
use App\Repositories\Fleet\SparepartRepository;
use Illuminate\Http\Request;
use App\Http\Controllers\AppBaseController;
use App\Http\Resources\Fleet\SparepartResource;
use Response;

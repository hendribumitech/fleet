...
use App\Http\Requests\API\Fleet\CreateCategoryAPIRequest;
use App\Http\Requests\API\Fleet\UpdateCategoryAPIRequest;
use App\Models\Fleet\Category;
use App\Repositories\Fleet\CategoryRepository;
use Illuminate\Http\Request;
use App\Http\Controllers\AppBaseController;
use App\Http\Resources\Fleet\CategoryResource;
use Response;

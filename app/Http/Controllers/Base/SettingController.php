...
class SettingController extends AppBaseController
{
    ...
    protected $baseRoute = 'base.settings';
    protected $baseView = 'base.settings';
    ...
    public function show($id)
    {
        ...
        return view($this->baseView.'.show')->with('setting', $setting);
    }
    ...
    public function edit($id)
    {
        ...
        return view($this->baseView.'.edit')->with('setting', $setting)->with($this->getOptionItems());
    }
